...
public class CopyOfClient implements Runnable{
	// 空闲计数器,如果空闲超过10次,将检测server是否中断连接.
	    ...
	    public CopyOfClient() throws IOException {
	    ...
	    public void run() {
	        ...
	        while (true) {
	            ...
	            try {
	                ...
	                int num = this.selector.select(2000);
	                ...
	                while (it.hasNext()) {
	                    ...
	                    if (key.isReadable()) {
	                     ...
	                     this.temp = ByteBuffer.allocate(1024);
	                        ...
	                        System.out.println("Client_1 received ["+msg+"] from server address:" + sc.getRemoteAddress());
