...
<body>
	<form:form id="inputForm"  action="${ctx}/apply/leave/doHandle" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				${budgetRecord.leaveApproval.reason}
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				${budgetRecord.leaveApproval.days}
			</div>
		</div>
		<div class="control-group">
