...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/apply/loan/list?type=4">我的申请</a></li>
		<li class="active"><a href="${ctx}/apply/loan/_list?type=4">我的审批</a></li>
		<shiro:hasPermission name="apply:budget:edit"><li><a href="${ctx}/apply/loan/_add?type=4">创建申请</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="budgetRecord" action="${ctx}/apply/loan/_list?type=4" method="post" class="breadcrumb form-search ">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<sys:message content="${message}"/>
			<tr>
				...
				<th style="text-align: center;">预算摘要</th>
		...
		<c:forEach items="${page.list}" var="loan" varStatus="index">
			<tr>
				...
				<shiro:hasPermission name="apply:budget:edit"><td style="text-align: center;">
					<c:if test="${loan.budgetRecord.status == 0}"><a href="${ctx}/apply/loan/contractHandle?id=${loan.budgetRecord.id}">办理</a></c:if>
