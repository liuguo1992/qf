	...
	<div id="main">
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy;${fns:getConfig('copyrightYear')}${fns:getConfig('productName')} - Powered By <a href="http://www.qfighting.com/" target="_blank">${fns:getConfig('productName')}</a> ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
